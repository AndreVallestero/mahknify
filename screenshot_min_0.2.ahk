SaveCodeToImg() {
	...
	WinGetPos, winX, winY, winWidth, winHeight, A ; current active window
	hdc_frame := DllCall( "GetDC", "UInt",  winId )
	hdc_buffer := DllCall( "gdi32.dll\CreateCompatibleDC", "UInt", hdc_frame )
	hbm_buffer := DllCall( "gdi32.dll\CreateCompatibleBitmap", "UInt", hdc_frame, "Int", 58, "Int", 24 )
	DllCall( "gdi32.dll\SelectObject", "UInt", hdc_buffer, "UInt", hbm_buffer )
	DllCall( "gdi32.dll\BitBlt", "UInt", hdc_buffer, "Int", 0, "Int", 0, "Int", 58, "Int", 24, "UInt", hdc_frame,  "Int", winX + 670, "Int", winY + 374, "UInt", 0x00CC0020 )
